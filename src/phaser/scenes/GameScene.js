...
export default class GameScene extends Phaser.Scene {
  ...
  create () {
    ...
    this.l = new EmojiText(this, 100, 100, { text:'💪',size: 70, matterBodyConfig: { mass: 0, shape: { type: 'rectangle', width: 70, height: 40 } }});
    this.r = new EmojiText(this, 100, 100, { text:'💪',size: 70, matterBodyConfig: { mass: 0, shape: { type: 'rectangle', width: 70, height: 40 } }});
    this.a = new EmojiText(this, 100, 100, { text:'👍',size: 40, matterBodyConfig: { mass: 1 }});
    this.z = new EmojiText(this, 100, 100, { text:'👍',size: 40, matterBodyConfig: { mass: 1 }});
    ...
    // right wrist
    var constraint = Phaser.Physics.Matter.Matter.Constraint.create({
      bodyA: this.r.gameObject.body,
      bodyB: this.z.gameObject.body,
      pointA: { x: 0, y: -35 },
      pointB: { x: 0, y: 0 },
      length: 0,
      stiffness: STIFFNESS,
    ...
    setInterval(() =>  this.h.gameObject.setVelocityY(-50), 1_000);
  }
